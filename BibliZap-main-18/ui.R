  ...
  div(class = "custom-content",
      tabsetPanel(tags$style(HTML(".nav-tabs > li > a { color: black !important; }")),
                  ...
                  tabPanel("How does it work ?",
                           ...
                           h2("Data"),
                           p("Meta-data from articles are provided by The Lens, a not-for-profit service from Cambia. The Lens gathers and harmonises bibliographic data from different sources (Crossref, PubMed, Microsoft Academic, ...):"),
                           tags$img(src = "scholar-venn.png", width = "400px"),
                           tags$img(src="scholar-chart.png", width='400px'),
                           p("The Lens is free to use for individuals. It provides an API for institutional use for which a free token can be obtained for 14 days."),
                           p("Using the BibliZap web-app freely is possible thanks to The Lens generously providing an API access to all users of the BibliZap web-app. Users of the R package will need a spectific individual token which can be obtained through The Lens for 14 days."),
                           p("BibliZap does not recieve financial support from The Lens or Cambia, or any other enterprise or journal."),
